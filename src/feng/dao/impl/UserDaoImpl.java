...
public class UserDaoImpl implements UserDao {
	...
	public void add(User user) {
		try{
			...
			String sql = "insert into user(id,name,password,phone,cellphone,address,email) values(?,?,?,?,?,?,?)";
			Object params[] = {user.getId(),user.getName(),user.getPassword(),user.getPhone(),user.getCellphone(),user.getAddress(),user.getEmail()};
